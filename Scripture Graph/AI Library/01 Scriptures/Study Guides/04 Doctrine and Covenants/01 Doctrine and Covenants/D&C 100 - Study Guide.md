...
Scripture: [[D&C 100]] · My notes: [[D&C 100 - My Notes]]
...
## Structure & Setting
<!-- SG:BEGIN structure -->
A descriptive outline is:

1. **Reassurance and summons (vv. 1–2):** the families are declared well, followed by a command to follow and listen.
2. **Missionary commission (vv. 3–12):** the mission's purpose is stated, inspired proclamation is promised and regulated, complementary roles are assigned, and divine presence is reaffirmed.
3. **Word concerning Zion (vv. 13–17):** chastening is set beside redemption, comfort, sanctification, purity, righteous service, and salvation.

The counsel to let the heart rejoice or be comforted in verses 12 and 15 helps connect the personal mission with the communal crisis. This is an editorial outline of subject shifts, not evidence of a specialized ancient literary form.
<!-- SG:END structure -->
...
## Literary Features
<!-- SG:BEGIN literary -->
Two modest patterns reward attention. First, verse 1 locates all power in the Lord, while verses 10–11 describe power for testimony and scripture exposition as something given to the servants. Their ministerial ability is therefore represented as derivative. Second, verses 13–17 associate chastening, redemption, sanctification, purity, righteous service, and salvation. This thematic association is clear, but the verses do not explicitly define those ideas as successive stages in a single causal process.
<!-- SG:END literary -->
...
> The statement that all things work together for good to those who walk uprightly is a close adaptation of Romans 8:28. D&C 100 applies that Pauline assurance specifically to upright conduct and the church's sanctification.
> — strength 0.8 · confidence 1.0 · Strong adaptation; mechanism and wider significance disputed · [[Verbal Scriptural Parallel in D&C 100|full dossier]]
...
<!-- SG:BEGIN questions -->
- How do the requirements in verses 7–8 shape the promise of inspired speech in verses 5–6?
- How do the roles of spokesman, expositor, testifier, and revelator cooperate in verses 9–11?
- What does "good" mean in verse 15 when verse 13 openly acknowledges chastening?
- Does "for a little season" provide a definite timetable, or chiefly contrast temporary chastening with promised redemption?
- How does "the sanctification of the church" in verse 15 relate to the pure people described in verse 16 without requiring an unstated mechanical sequence?
<!-- SG:END questions -->
