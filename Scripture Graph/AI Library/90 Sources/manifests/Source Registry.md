...
- **Journals and writings of the prophets (public domain)** — Discourses of Brigham Young, Gospel Doctrine, Mediation and Atonement, Leaves from My Journal, Pratt's autobiography and more (corpus/prophets.py).
- **Words of the Prophets (your own permitted material)** — Drop legally obtained volumes, journals or family documents into sources/drop/prophets/.
