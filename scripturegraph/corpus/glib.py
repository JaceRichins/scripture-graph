...
COLLECTIONS: dict[str, dict] = {
    ...
    "true-to-the-faith": {"uri": "/manual/true-to-the-faith", "source": "gospel-topics",
                          ...
                          "folder": f"{_FT}/True to the Faith",
